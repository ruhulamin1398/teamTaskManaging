...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 bg-abasas-dark">
                <nav class="navbar navbar-dark ">
                    <a class="navbar-brand">Status List</a>
    ...
    <!-- Attachment Modal -->
    <div class="modal fade" id="status-edit-modal" tabindex="-1" role="dialog" aria-labelledby="edit-modal-label" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-dark" id="edit-modal-label ">Edit Status</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" id="attachment-body-content">
                    <form id="status-edit-form" class="form-horizontal" method="POST" action="">
                    @csrf
                        @method('put')
...
$(document).on('click', "#status-edit-item", function() {
    ...
    $('#status-edit-modal').modal(options)
  });

  // on modal show
  $('#status-edit-modal').on('show.bs.modal', function() {
  ...
  //on modal hide
  $('#status-edit-modal').on('hide.bs.modal', function() {
    $('.edit-item-trigger-clicked').removeClass('edit-item-trigger-clicked')
    $("#status-edit-form").trigger("reset");
  });
}) ;
</script>
